Feature: Register to the automationpractice website

  @RegisterWithCorrectCredentials
  Scenario: Register to the website with required fields
    Given User open main page
    And   I click on Sign In button
    And   I enter email address "bratkowskaaleksandra+5@gmail.com" to create an account
    ...
    Then   I check if user is registered to the website
  ...
  @RegisterWithIncorrectCredentials
   Scenario: Register with existing email
    ...
    Given User open main page
    And   I click on Sign In button
    And   I enter email address "tata@tata.com" to create an account
